                      ...
                      >
                        <Select
                          ...
                          onValueChange={(value) => {
                            ...
                            getCities({
                              countryCode: liveValues?.myLocations?.[index]
                      ...
                      {cityList.length > 0 ||
                        ((liveValues?.myLocations?.[index]?.locations?.[
                          ...
                          <FormField
                            ...
                            name={`myLocations.${index}.locations.${locationIndex}.cities`}
                          >
                            <MultipleSelector
                              value={liveValues?.myLocations?.[
                                index
                              ]?.locations?.[locationIndex]?.cities?.map(
                                (x) => ({
                                  value: x,
                                  label: x,
                                })
