    ...
    return (
      ...
      >
        <AccordionItem value="item-1" className="my-2 border-0">
          <AccordionTrigger className="rounded-md py-2.5 pl-2.5 pr-1 text-sm font-medium transition-colors duration-200 ease-in hover:bg-secondary/10 hover:text-secondary disabled:cursor-not-allowed disabled:bg-muted disabled:text-muted-foreground">
