...
const sidebarOptions: TypeSidebarProps[] = [
  {
    ...
    subMenu: [
      ...
      {
        icon: <MdDataUsage className="mr-2 h-5 w-5" />,
        title: "Data Analysis",
        path: "/admin/dashboard/data-analysis",
        type: "item",
      },
      {
        icon: <FaTruckMedical className="mr-2 h-5 w-5" />,
        title: "Suppliers",
        path: "/admin/dashboard/supplier-management",
        type: "item",
      },
      {
        icon: <MdNotificationsActive className="mr-2 h-5 w-5" />,
        title: "Notifications",
        path: "/admin/dashboard/notifications",
        type: "item",
      },
      {
        icon: <MdReportOff className="mr-2 h-5 w-5" />,
        title: "Mis Reports",
        path: "/admin/dashboard/mis-reports",
        type: "item",
      },
      {
        icon: <MdContacts className="mr-2 h-5 w-5" />,
        title: "Contact Management",
        path: "/admin/dashboard/contact-management",
        type: "item",
      },
    ],
  },
