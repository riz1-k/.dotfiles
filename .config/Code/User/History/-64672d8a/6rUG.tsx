    ...
    <main className='flex flex-col bg-background p-2'>
      <section className='relative h-[165px] w-full md:h-[280px]'>
        ...
        <div className='absolute top-0 flex h-full w-full flex-col p-2'>
          <section className='flex h-8 w-full justify-between'>
            ...
            {trustVerified && (
              <VerifiedSealCard storeURL={storeURL}>
                <div className='flex flex-col items-center justify-center  font-semibold'>
                  ...
                  />
                  <span className='-mt-1 rounded-full bg-green-400 px-0.5 text-[6px] text-primary-foreground'>
                    Verified Profile
                  </span>
                </div>
              </VerifiedSealCard>
          ...
          <section className='-mr-4 mt-auto flex items-end justify-end px-4'>
            <DropdownMenu>
              ...
              <DropdownMenuContent
                align='end'
                className='max-h-40 overflow-y-auto bg-input'
              >
                {wishlists?.map((x) => (
                  <DropdownMenuItem
                    key={x._id}
      ...
      >
        <div className='flex items-center'>
          <p className='line-clamp-1 text-clip text-sm font-bold md:text-lg'>
            {title}
          </p>
          {isRequstPage && (
            <h2
