  ...
  return (
    <div className="container mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
        <Card className="min-h-[88vh] shadow-lg md:col-span-2">
          <CardHeader>
          ...
          <CardContent>
            ...
            >
              ...
              <ScrollArea className="h-full w-full space-y-4 rounded-md border bg-white p-4 shadow-inner">
        ...
        <div className="space-y-6">
          ...
          <Card className="shadow-lg">
            ...
            <CardContent>
              <ScrollArea className="h-fit w-full rounded-md border bg-white p-4 shadow-inner">
