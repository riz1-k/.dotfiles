...
function BusinessProfilePage() {
  ...
  useEffect(() => {
    ...
    form.reset({
      ...
      storeData: {
        about: storeData.storeData.about,
        businessEmail: storeData.storeData.businessEmail,
        businessPhone: storeData.storeData.businessPhone,
        contactInfo: storeData.storeData.contactInfo,
      },
    });
  }, [storeData]);
...
export type TStoreData = ISellerStore & {
  storeData: {
    ...
    listingType: string;
    about: string;
    contactInfo: TFormSchema['storeData']['contactInfo'];
    highlights: TFormSchema['storeData']['highlights'];
    timings: Required<TFormSchema['storeData']['timings']>;
    specialities: string[];
    howCanWeHelp: string[];
    timezone: string;
