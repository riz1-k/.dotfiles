...
export default function VerifiedSealCard({ open, setOpen, storeURL }: ISeal) {
      ...
      >
        <DialogHeader className='!border-none'>
          <DialogTitle className='!flex !h-20 !w-full items-center  gap-3 px-3'>
            ...
            <div className='ml-auto mt-5 flex h-12 w-12 items-center justify-center rounded-full bg-secondary'>
