      ...
      .array(
        z.object({
          ...
          locations: z
            ...
            .min(1, {
              message:
                'At least one location must be selected for your service',
            }),
        })
      )
      .min(1, { message: 'Select at least one location for your service' })
      .nullable()
      .default(null),
    customerLocations: z
      .array(
      ...
      .min(1, { message: 'Select at least one location for customer' })
      .optional(),
    online: z
